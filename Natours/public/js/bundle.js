      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error signing up. Please try it again later!');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_JswB5B35fmWSi0X7pZO0A8R400PH3HQ5D7'); //* 1) Get checkout session from api
...
if (registerForm) {
  registerForm.addEventListener('submit', function (e) {
    ...
    (0, _auth.register)(name, email, password, passwordConfirm);
  });
}
